...
def get_tweets():
    tweetCriteria = got.manager.TweetCriteria().setQuerySearch('corona virus') \
        ...
        .setUntil("2021-09-30") \
        .setMaxTweets(10)
    tweets = got.manager.TweetManager.getTweets(tweetCriteria)[tweetCriteria]
...
tokenized_words = word_tokenize(cleaned_txt, "english")# creates list of all the words separated by comma
